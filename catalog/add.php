    ...
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input" type="text" placeholder="Название товара" name="name">
                </div>
            </div>
            <div class="field">
            ...
            <div class="field">
                ...
                <div class="control">
                    <textarea class="textarea" placeholder="Введите описание товара" name="body"></textarea>
                </div>
            </div>
            ...
            <div class="field">
                <div class="control">
                    <label class="checkbox">
                        <input type="checkbox" name="isSale"> Распродажа
                    </label>
                </div>
            </div>
