    ...
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input" type="text" placeholder="Название новости" name="title" value="Первая новость">
                </div>
            </div>
            <div class="field">
            ...
            <div class="field">
                ...
                <div class="control">
                    <textarea class="textarea" placeholder="Введите новость" name="body">Привет, я первая новость на сайте</textarea>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input" type="text" placeholder="Введите имя автора" value="Волков Михаил" name="author">
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input" type="text" placeholder="Введите имя автора" name="tags" value="Новинка,Первый,Сайт">
                </div>
            </div>
