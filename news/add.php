    ...
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input" type="text" placeholder="Название новости" name="title">
                </div>
            </div>
            <div class="field">
                <label class="label">Краткое описание *</label>
                <div class="control">
                    <input class="input" type="text" placeholder="Краткое описание" name="excerpt">
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <textarea class="textarea" placeholder="Введите новость" name="body"></textarea>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input" type="text" placeholder="Введите имя автора" name="author">
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="control">
                    <input class="input" type="text" placeholder="Введите имя автора" name="tags">
                </div>
            </div>
